...
test("v0.12.18 user-facing language removes known internal/AI-style phrases", () => {
...
test("v0.12.18 keeps precise total-score wording distinct from calculated subtotals", () => {
